...
| `layout`          | `LayoutSlots`                                                             | No       | Replace form wrapper, section wrapper, submit button, array row layout, or `loadingFallback`. Use `null` for omittable slots (submit/array buttons). Defaults to `{}`       |
